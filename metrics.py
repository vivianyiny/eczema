...
def binary_classification_summary(y, y_predicted,y_score):
    ...
    classification_summary = pd.DataFrame([acc, sen, spe, auc, mcc], index = ["Accuracy", "Sensitivity", "Specificity", "AUROC", "Matthews Corr. Coef."], columns = ["Score"])
